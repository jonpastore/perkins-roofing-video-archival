...
- **Most recent:** [CONTINUATION-2026-07-20-pm.md](CONTINUATION-2026-07-20-pm.md) (pm batch: TikTok refresh-token persist, article-job no-op, non-root Docker, Cloud Run 5xx/job-failure alert policies + activation (alert_email=dmarc@perkinsroofing.net), suggest-clips 500 fix (null timestamps), 4 admin/estimating UI fixes, Clip Studio help modal, core/proposal_review.py (fairness+prompt-injection reviewer, unwired). RESUME TASKS: (1) build Quoting config panel, (2) wire T&C/FAQ/AI-prompt pages + review into proposal gen, (3) AV end-to-end render test — offload to qwen/CF heavily. API ddc6dab, HEAD 749a38d)
- [CONTINUATION-2026-07-20.md](CONTINUATION-2026-07-20.md) (full social-publishing backbone + platform-aware Clip Studio: platform_specs+preflight, social_creds store-first resolver wired into social_job (connect→publish), checkbox multi-post, retired mocked distribute_job, platform preset buttons; auto-censor complete (audio mute + burned-caption masking, crude + tenant denylist); creative gaps — audit found reframe/captions/per-platform-copy already existed — filled: focal-point slider, scene-cut (speech-gap + visual ffmpeg scdet), fit badges; follow-ons all done incl. transcode conform wired into render; **gotenberg perpetual scaling drift FIXED — terraform plan fully clean for the first time**. 21 commits, API cb82872, deployed, IaC applied 0-changes)
- [CONTINUATION-2026-07-19.md](CONTINUATION-2026-07-19.md) (finished Zoom 1d low-slope inputs + roof_type boundary 422 fix; B8 branch-admin role fix; R6 commit rule; CompanyCam connector + B9 QuickBooks per-branch scaffold (both inert/held); full Cloudflare IaC drift cleanup incl. v4→v5 provider migration on LIVE email DNS with 0 destroyed + vestigial Cloud Run domain-mapping removal; 6-way deep review (deepsec/critic/architect/designer/local) — platform SOUND, demo-critical UX + CompanyCam-probe fixes shipped. API b9777a2 rev api-00109-lbb, SPA live on app.perkinsroofing.net)
- Archived: [docs/continuations/CONTINUATION-2026-07-17-night.md](docs/continuations/CONTINUATION-2026-07-17-night.md) · [docs/continuations/CONTINUATION-2026-07-17-eve.md](docs/continuations/CONTINUATION-2026-07-17-eve.md) · [docs/continuations/CONTINUATION-2026-07-17.md](docs/continuations/CONTINUATION-2026-07-17.md) · [docs/continuations/CONTINUATION-2026-07-16.md](docs/continuations/CONTINUATION-2026-07-16.md) · [docs/continuations/CONTINUATION-2026-07-11-eve.md](docs/continuations/CONTINUATION-2026-07-11-eve.md) · [docs/continuations/CONTINUATION-2026-07-11.md](docs/continuations/CONTINUATION-2026-07-11.md) · [docs/continuations/CONTINUATION-2026-07-11-pm.md](docs/continuations/CONTINUATION-2026-07-11-pm.md) ·
