...
- **Most recent:** [CONTINUATION-2026-07-17-eve.md](CONTINUATION-2026-07-17-eve.md) (autopilot Monday-demo wave: branch management live in prod (migration 0041, /branches CRUD, customer/dashboard association), gutters = Tim's style-based price model, existing_roof tear-off semantics, package_options = full verified tier menu on every quote, comments OAuth capture live, coastal setback checker at perkins-setback.web.app, Zoom deep-analysis w/ action items)
...
- Archived: [docs/continuations/CONTINUATION-2026-07-11-eve.md](docs/continuations/CONTINUATION-2026-07-11-eve.md) · [docs/continuations/CONTINUATION-2026-07-11.md](docs/continuations/CONTINUATION-2026-07-11.md) · [docs/continuations/CONTINUATION-2026-07-11-pm.md](docs/continuations/CONTINUATION-2026-07-11-pm.md) ·
