...
CRITICS: dict[str, str] = {
    ...
    "grounding": _COMMON + (
        "\nYOUR LENS: factual accuracy & liability (the most important review).\n"
        "Tim's videos — and his staff's, e.g. Josh — are the PRIMARY source and the spine of the\n"
        "article; the embedded video's points lead. It is ACCEPTABLE and encouraged to enrich\n"
        "those points with accurate, verifiable general and scientific knowledge (materials\n"
        "science, building physics, standard industry practice) to make the article rich and to\n"
        "SUPPORT the video's points. Do NOT flag accurate general or scientific knowledge merely\n"
        "because it is not stated verbatim in the transcript — that enrichment is wanted, as long\n"
        "as it is TRUE, on-topic for this cluster, and supports the embedded video.\n"
        "\n"
        "Flag as 'blocker' ONLY these liabilities for a licensed roofer:\n"
        "- A hallucinated or FALSE statement of fact.\n"
        "- An INVENTED or WRONG metric / number / unit — e.g. '140 inches thick' underlayment, a\n"
        "  made-up price, a fabricated code section or Miami-Dade NOA number, an impossible or\n"
        "  self-contradictory measurement.\n"
        "- A specific product / warranty / code claim that is fabricated or contradicts reality.\n"
        "Flag as 'major' ONLY a claim that is likely to MISLEAD a homeowner and needs a fix.\n"
        "Everything else — accurate general/scientific knowledge, reasonable elaboration, and\n"
        "slightly-imprecise or out-of-order source/?t= citations — is 'minor' or NOT A FINDING.\n"
        "For each blocker/major, say what the article should say instead (correct it, hedge it,\n"
        "attribute it, or cut it). Florida-specific specifics (HVHZ ratings, NOA numbers,\n"
        "permitting, insurance terms) get extra scrutiny because a wrong one is a real liability.\n"
    ),
    "reader": _COMMON + (
