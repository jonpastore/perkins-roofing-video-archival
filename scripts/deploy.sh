...
CFG_ENV="WP_URL=${WP_URL:-}|WP_USER=${WP_USER:-}|OAUTH_CLIENT_ID=${OAUTH_CLIENT_ID:-}|YT_OWNER_CHANNEL_ID=${YT_OWNER_CHANNEL_ID:-}|GOTENBERG_URL=${GOTENBERG_URL:-}|SIGN_PUBLIC_URL=${SIGN_PUBLIC_URL:-}|OAUTH_REDIRECT_BASE=${OAUTH_REDIRECT_BASE:-}|EMAIL_SEND_MODE=${EMAIL_SEND_MODE:-test}|EMAIL_TEST_RECIPIENT_ALLOWLIST=${EMAIL_TEST_RECIPIENT_ALLOWLIST:-jpastore79@gmail.com,@degenito.ai,@perkinsroofing.net}|KNOWIFY_PULL_MODE=mcp|BILLING_BQ_TABLE=${BILLING_BQ_TABLE:-video-archival-and-content-gen.billing_export.gcp_billing_export_v1_01549D_4220C6_D775AD}"
